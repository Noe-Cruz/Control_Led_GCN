import 'package:app_control/pages/color_picker.dart';
import 'package:app_control/pages/conection.dart';
import 'package:app_control/pages/control_led.dart';
...
class _HomeState extends State<Home> {
  ...
  final List<Widget> _pages = [
    const Conection(),
    const ControlLed(),
    const LightControl()  // Elimina la dependencia de ConectionState aquí
  ];
